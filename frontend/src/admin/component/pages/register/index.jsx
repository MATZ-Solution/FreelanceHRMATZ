                        ...
                        <div className="loginbox">
                            <div className="login-right">
                                <div className="login-right-wrap">
                                    <h1>Join MATZ Solutions Platform</h1>
                                        ...
                                        >
                                            ...
                                            <form>
                                                ...
                                                <div className="dont-have">
                                                    <p>
                                                        You agree to the MATZ Solutions Platform <Link to="#">User Agreement,</Link>{" "}
                                                ...
                                                <div className="row form-row login-foot">
                                                    ...
                                                    <div className="col-lg-6 dont-have">
                                                        New to MATZ Solutions Platform? <Link to="/admin/register">Click here</Link>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
