...
const UserDetails = () => {
  ...
  const updateUserProfile = async () => {
    try {
      const updateProfileRequest = await fetch('https://freelanceserver.matzsolutions.com/profileHeader', {
        method: "POST",
        headers: {
  ...
  const updateExperience = async () => {
    try {
      const updateExperienceRequest = await fetch('https://freelanceserver.matzsolutions.com/experience', {
        method: "POST",
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
  ...
  const updateCoverImage = async (selectedFile) => {
    ...
    try {
      let updateCoverImgReq = await fetch('https://freelanceserver.matzsolutions.com/cover', {
        method: "POST",
        headers: {
          'Authorization': `Bearer ${token}`,
        },
  ...
  const updateProfileImage = async (selectedFile) => {
    ...
    try {
      let updateProfileImgReq = await fetch('https://freelanceserver.matzsolutions.com/profile', {
        method: "POST",
        headers: {
          'Authorization': `Bearer ${token}`,
        },
  ...
  const updateOverView = async () => {
    try {
      const updateOverViewRequest = await fetch('https://freelanceserver.matzsolutions.com/profileOverview', {
        method: "POST",
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
  ...
  const updateEducation = async () => {
    try {
      const updateEducationReq = await fetch('https://freelanceserver.matzsolutions.com/education', {
        method: "POST",
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
  ...
  const updateSkills = async () => {
    if (skillsArray.length !== 0) {
      try {
        const updateSkillsReq = await fetch('https://freelanceserver.matzsolutions.com/skill', {
          method: "POST",
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`,
  ...
  const getProfileData = async () => {
    try {
      const getProfileReq = await fetch('https://freelanceserver.matzsolutions.com/getUserProfile', {
        method: "GET",
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
                          ...
                          <div className="form-group profile-group mb-0">
                            <div className="input-group">
                              <input
                                type="text"
                                className="form-control"
                              // defaultValue="https://www.MATZ Solutions Platform.com/developer/daren/12454687"
                              />
                              <div className="input-group-append">
                                <button
                                  className="btn btn-success sub-btn" >
                          ...
                          <div style={{ marginTop: '0.75rem', width: '100%', display: 'flex', flexWrap: 'wrap', gap: '0.75rem' }}>
                            {
                              skillsArray.map((skills, index) => {
                                return (
                                  <div key={index} style={{ display: 'flex', gap: "9px", background: '#48AB6A', borderRadius: '0.375rem', fontSize: '1.125rem' }}>
