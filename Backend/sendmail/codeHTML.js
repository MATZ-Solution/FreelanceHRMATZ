exports.forgetHTML = (name, random) => {
  return `
  <!DOCTYPE html>
<html lang="en">
<head>
  ...
  ">Hi <span style="color: #1672BA;font-weight: 700; font-size: 25px;"><b>${name}</b></span>,</h1>
                <p class="near_title last" style="margin-top: 10px;margin-bottom: 0; color: gray; font-family: figtree;">Please verify that your email address , and that you entered it when signing up for MATZ Solutions Freelance.</p>
  ...
  background: #F4FBF9;">
    ...
    vertical-align: top;
      border: none !important;
  padding: 20px;">
                <p class="marginless" style="margin: 0; font-family: figtree;">Thank You, <br>MATZ Solutions </p>
              </td>
            </tr>
          </tbody></table>
        </td>
  ...
  ">
    ...
    line-height: 1.5;
  ">
          If you did not enter this email address when signing up for MATZ Solutions Freelance service, disregard this message.<br><br>
          M1, Raza Arcade, Sharah-e-Faisal, Karachi, Pakistan
  <br><br>
  
  This is a mandatory service email from MATZ Solutions Freelance.
  </p>
        </td>
      </tr>
    </tbody></table>
...
exports.welcome = (name) => {
  return `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
    ...
    <tbody style="margin-top: 15px;">
      <tr class="">
    <td class="">
    <img alt="Spade Rent" src="https://res.cloudinary.com/dao9gnwv4/image/upload/v1713168896/logo-01_dppf2o.png" width="155" style="
    margin-bottom: 15px;
    ">
    </td>
    </tr>
    <tr class=""><td class="headline">Welcome <b>${name}</b> to MATZ Solutions Freelance!</td></tr>
    <tr>
    <td>
    <center class=""><table cellpadding="0" cellspacing="0" class="" style="margin: 0 auto;" width="75%"><tbody class=""><tr class="">
    <td class="" style="color:#444; font-weight: 400;"><br><br>
    Welcome to our freelancing platform, where talent meets opportunity! Whether you're a seasoned professional or just starting your journey as a freelancer, our platform provides the perfect environment to showcase your skills and connect with clients from around the globe.
      <br><br>
      As a freelancer on our platform, you have the freedom to choose projects that align with your expertise and interests. From creative writing to graphic design, web development to digital marketing, there's a diverse range of opportunities waiting for you.
      <br>
     <br>
